...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Check if facilitator has completed onboarding
    const facilitatorProfile = localStorage.getItem("facilitatorProfile")
    const isAuthenticated = localStorage.getItem("isAuthenticated")

    if (!facilitatorProfile || !isAuthenticated) {
      // New facilitator, start onboarding
